...
function getUser(req, res) {
    if (req.user) {
        ...
        const { id, email, firstname, lastname, bio, profile_picture, signed_up_at, last_seen_at, } = req.user;
...
export { signUpHandler, loginHandler, getUser, userAlreadySignedUp, logOutHandler, };
